    ...
    <section className="relative h-screen-safe w-full overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-5 md:px-6">
        ...
        <div className="flex flex-col sm:flex-row gap-2.5 sm:gap-4 w-full sm:w-auto opacity-0 animate-fade-up px-2 sm:px-0" style={{ animationDelay: "1.1s" }}>
          <a
            href="#booking"
            className="bg-gold text-gold-foreground px-6 sm:px-10 py-3.5 md:py-4 text-xs md:text-sm tracking-[0.2em] uppercase font-body font-semibold hover:bg-gold/90 transition-all duration-300 hover:shadow-lg hover:shadow-gold/20 text-center touch-target"
          >
            Bóka tíma
          </a>
          <a
            href="#services"
            className="border border-volcanic-foreground/30 text-volcanic-foreground px-6 sm:px-10 py-3.5 md:py-4 text-xs md:text-sm tracking-[0.2em] uppercase font-body hover:border-gold hover:text-gold transition-all duration-300 text-center touch-target"
          >
            Þjónusta
          </a>
        </div>
        ...
        <div className="mt-5 md:mt-8 opacity-0 animate-fade-up" style={{ animationDelay: "1.4s" }}>
          <p className="font-body text-volcanic-foreground/50 text-[10px] md:text-sm tracking-wider">
            ✨ Fyrsta heimsóknin? <span className="text-gold font-semibold">20% afsláttur</span>
          </p>
        </div>
      </div>
